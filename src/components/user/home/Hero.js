...
//         className="absolute top-20 right-40 w-96 h-96 bg-red-600 rounded-full blur-3xl"
//       />
//       <motion.div
//         animate={{
//           scale: [1.2, 1, 1.2],
...
//         className="absolute bottom-20 left-20 w-80 h-80 bg-red-900 rounded-full blur-3xl"
//       />

//       {/* Content - Split Left/Right Layout */}
...
//                 className="inline-flex items-center gap-3 px-5 py-2.5 bg-red-600/20 border border-red-600 backdrop-blur-xl relative"
//               >
...
//                 <span className="text-red-400 font-black text-xs tracking-[0.25em] uppercase">
//                   About Murugesan —
...
//                   <span className="  text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-red-600 to-red-500 drop-shadow-2xl">
//                     GESAN
//                   </span>
//                 </h1>
//               </motion.div>
...
//                   whileTap={{ scale: 0.95 }}
//                   className="group relative px-8 py-4 bg-red-600 text-white font-black text-base uppercase tracking-wider overflow-hidden"
//                 >
//                   <motion.div
...
//                     transition={{ duration: 2, repeat: Infinity }}
//                     className="absolute top-0 left-0 w-3 h-3 border-t-2 border-l-2 border-white"
//                   />
//                   <motion.div
//                     animate={{ scale: [1, 1.1, 1] }}
//                     transition={{ duration: 2, repeat: Infinity }}
//                     className="absolute bottom-0 right-0 w-3 h-3 border-b-2 border-r-2 border-white"
//                   />
//                 </motion.a>
...
//                   whileHover={{ scale: 1.05 }}
//                   whileTap={{ scale: 0.95 }}
//                   className="group relative px-8 py-4 bg-white/10 border-2 border-white/30 text-white font-black text-base uppercase tracking-wider backdrop-blur-md overflow-hidden"
//                 >
//                   <motion.div
            ...
            >
              ...
              >
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-none tracking-tighter">
                  <span className="text-white drop-shadow-2xl">MURU</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[var(--tamil-orange)] via-[var(--tamil-orange-light)] to-[var(--tamil-orange)] drop-shadow-2xl">
                    GESAN
                  </span>
                </h1>
              </motion.div>
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7, delay: 0.6 }}
                className="text-sm md:text-base text-[var(--tamil-white-muted)] max-w-xl leading-relaxed"
              >
                Experience epic gaming moments and legendary gameplay from Tamil
                Gaming&apos;s most iconic character across multiple universes.
              </motion.p>
